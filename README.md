...
[Vagrant Skadi Server 2018.3](https://app.vagrantup.com/skadivm/boxes/skadi_server): Headless Skadi server available through Vagrant. Install Vagrant and VirtualBox and then use this [Vagrant file](https://github.com/orlikoski/Skadi/tree/vagrant/Vagrant) to get started
