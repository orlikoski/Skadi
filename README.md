...
[Vagrant Skadi Server 2018.3](https://app.vagrantup.com/skadivm/boxes/skadi_server): Headless Skadi server available through Vagrant. Install Vagrant and VirtualBox and then [use this example Vagrant file for VirtualBox to get started](https://github.com/orlikoski/Skadi/tree/vagrant/Vagrant)
